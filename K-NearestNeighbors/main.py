...
x_train, y_train = InOut.load_mnist(r"K-NearestNeighbors/Databases/", kind="train")
x_test, y_test = InOut.load_mnist(r"K-NearestNeighbors/Databases/", kind="t10k")
...
plt.title("Accuracy of first 100 test.", fontsize=14)
